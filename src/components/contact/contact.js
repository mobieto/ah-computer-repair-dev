    ...
    return (
        <section id="contact-section" className="flex flex-col justify-center align-middle bg-white dark:bg-[#171a20]">
            ...
            <form ref={form} onSubmit={sendEmail} className="flex flex-col w-[80%] max-w-[48rem] justify-center align-middle mx-auto mt-10">
                ...
                <input type="text" name="from_name" className="bg-gray-300 dark:bg-gray-700 mt-1 rounded-md"/>
                ...
                <input type="text" name="from_email" className="bg-gray-300 dark:bg-gray-700 mt-1 rounded-md"/>
                ...
                <textarea name="message" className="bg-gray-300 dark:bg-gray-700 h-40 mt-1 rounded-md"/>
                <span className={`mt-1 text-xs text-red-500 font-poppins italic ${messageErrorState ? "block" : "hidden"}`}>Enter a message</span>
                <input type="submit" value="Send" className="bg-blue-600 hover:bg-blue-800 text-white rounded-2xl my-14 w-40 h-10 cursor-pointer mx-auto font-poppins text-xl [transition:background-color_.1s]"/>
            </form>

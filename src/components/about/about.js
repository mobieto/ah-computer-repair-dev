...
export default function About() {
    return (
        <section id="about-section" className="flex flex-col align-middle w-full overflow-y-auto bg-white dark:bg-[#171a20]">
            ...
            <img src={PortraitIcon} className="h-80 w-48 rounded-full"/>
            <iframe width="640" height="480" src="https://www.youtube.com/embed/21O0dngWoRk" title="Amin Hosseini Custom PC Build" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </section>
    )
}